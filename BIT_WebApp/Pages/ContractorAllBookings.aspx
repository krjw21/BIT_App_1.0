<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ContractorAllBookings.aspx.cs" Inherits="BIT_WebApp.Pages.ContractorAllBookings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid" style="margin: 100px 0 100px 0; background-color: #040315">
            ...
            <div style="color: #B8A5AE; font-size: 26px; margin-bottom: 10px; font-family: 'Goudy Old Style'">Here are your completed & rejected bookings:</div>
        </center>
        <div class="row">
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12 mx-auto">
                                <asp:GridView ID="gvBookings"
                                    ...
                                    <EmptyDataTemplate>There are no recorded jobs for this Contractor.</EmptyDataTemplate>
                                </asp:GridView>
                            </div>
                        </div>
                    </div>
